...
from src.utils.config import test_data_path, test_seg_path, val_y_seg_path, val_x_seg_path
...
def test(params):
    ...
    # ckpt.restore('../../data/checkpoints/training_checkpoints_pgn_tfs/ckpt-6')
